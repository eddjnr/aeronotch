...
function Expanded() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-[160px_1fr] h-full gap-3 overflow-hidden text-white", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 overflow-y-auto border-r border-white/[0.06] pr-2 scrollbar-none", children: [
      ...
      selectedRepos.map((repo) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `flex items-center gap-2.5 w-full text-left px-2 py-1.5 rounded-lg text-xs transition-colors focus:outline-none cursor-pointer ${selectedRepoFullName === repo.fullName ? "bg-white/[0.08] text-white font-semibold" : "text-white/50 hover:bg-white/[0.04]"}`,
            children: [
              /* @__PURE__ */ jsx(
                "span",
                {
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2 overflow-y-auto pr-1", children: selectedRepoFullName ? /* @__PURE__ */ jsxs(Fragment, { children: [
